  ...
  return (
    <div style={{ zIndex: 5 }} className='w-full sm:pl-[2rem] sm:pr-[2rem] h-[4rem] bg-white border-b border-[#DEDFE2] shadow-wd flex items-center justify-between pl-[4rem] pr-[4rem] fixed top-0'>
      ...
      <div className='flex justify-around items-center'>
        ...
        <button type="button" className="font-medium text-[#FFFFFF] bg-[#0052FE] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-m px-8 py-1.5 text-center m-auto ml-[4rem] sm:hidden md:hidden">
          Get Started
        </button>
